...
public class FinalProject extends Application {
    ...
    vb.getStylesheets().add((new File("src/finalProject/style.css")).toURI().toString());
    ...
    butsm.setOnAction (new EventHandler<ActionEvent>(){
        
        @Override
        public void handle(ActionEvent actinoEvent){
            if(tmn.getText().equals("Mahmoud") && tmp.getText().equals("123")){
                root1.getStyleClass().add("root");
                root1.getStylesheets().add((new File("src/finalproject/style.css")).toURI().toString());
        ...
        @Override
        public void handle(ActionEvent actinoEvent){
            scene1.getStylesheets().add((new File("src/finalproject/style.css")).toURI().toString());
            primaryStage.setTitle("Home");
            primaryStage.setScene(scene1);
            primaryStage.show();        }
        });
...
//         v3.setPadding(new Insets(20));
         ...
         root2.getStylesheets().add((new File("src/finalproject/style.css")).toURI().toString());
         Scene scene3 = new Scene(root2,1000,600);
    
        backbtn2.setOnAction (new EventHandler<ActionEvent>(){
        @Override
        public void handle(ActionEvent actinoEvent){
            scene2.getStylesheets().add((new File("src/finalproject/style.css")).toURI().toString());
            primaryStage.setTitle("Manage");
            primaryStage.setScene(scene2);
            primaryStage.show();        }
        });
        
        backbtnA.setOnAction (new EventHandler<ActionEvent>(){
        @Override
        public void handle(ActionEvent actinoEvent){
            scene1.getStylesheets().add((new File("src/finalproject/style.css")).toURI().toString());
            primaryStage.setTitle("Home");
        ...
        g11.getStylesheets().add((new File("src/finalproject/style.css")).toURI().toString());
        
        butec.setOnAction (new EventHandler<ActionEvent>(){
        @Override
        public void handle(ActionEvent actinoEvent){
            g11.getStyleClass().add("root");
            g11.getStylesheets().add((new File("src/finalproject/style.css")).toURI().toString());
        ...
        btbtn.setOnAction (new EventHandler<ActionEvent>(){
        @Override
        public void handle(ActionEvent actinoEvent){
            g12.getStyleClass().add("root");
            g12.getStylesheets().add((new File("src/finalproject/style.css")).toURI().toString());
        ...
        CheckBox cb1 = new CheckBox("i  agree to the terms of privacy");
        ...
        public void handle(ActionEvent actinoEvent){
            ...
            g13.getStylesheets().add((new File("src/finalproject/style.css")).toURI().toString());
            primaryStage.setTitle("Book page");
        ...
        backbtnAA.setOnAction (new EventHandler<ActionEvent>(){
        @Override
        public void handle(ActionEvent actinoEvent){
            scene1.getStylesheets().add((new File("src/finalproject/style.css")).toURI().toString());
            primaryStage.setTitle("Home");
        ...
        Alert a12 = new Alert(Alert.AlertType.CONFIRMATION,"Flight Deleted");
        a12.setTitle("error");
        ...
        cbbtn.setOnAction (new EventHandler<ActionEvent>(){
        @Override
        public void handle(ActionEvent actinoEvent){
            g14.getStyleClass().add("root");
            g14.getStylesheets().add((new File("src/finalproject/style.css")).toURI().toString());
